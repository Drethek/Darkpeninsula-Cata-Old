...
public:
    ...
    void HandleRoster(WorldSession *session = NULL, uint32 guid = 0, uint64 activity_weekly_xp = 0, uint64 activity_total_xp = 0, uint32 weekly_reputation = 0);          // NULL = broadcast
